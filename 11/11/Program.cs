    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for(int a = 0; a <= 16; a++)
            {
                for (int b = 0; b <= 16; b++)
                {
                    if (myArray[a][b]* myArray[a+1][b+1]*myArray[a+2][b+2]* myArray[a+3][b+3]> maxProduct)
                    {
                        maxProduct = myArray[a][b] * myArray[a + 1][b + 1] * myArray[a + 2][b + 2] * myArray[a + 3][b + 3];
                    }
                }
            }
            for (int a = 0; a <= 16; a++)
            ...
            for (int a = 0; a <= 16; a++)
            {
                for (int b = 0; b <= 19; b++)
                {
                    if (myArray[a][b] * myArray[a + 1][b] * myArray[a + 2][b] * myArray[a + 3][b] > maxProduct)
                    {
                        maxProduct = myArray[a][b] * myArray[a + 1][b] * myArray[a + 2][b] * myArray[a + 3][b];
                    }
                }
            }
            for (int a = 0; a <= 19; a++)
            {
                for (int b = 0; b <= 16; b++)
                {
                    if (myArray[a][b] * myArray[a][b + 1] * myArray[a][b + 2] * myArray[a][b + 3] > maxProduct)
                    {
                        maxProduct = myArray[a][b] * myArray[a][b + 1] * myArray[a][b + 2] * myArray[a][b + 3];
                    }
                }
            }
